...
export default function Achievements() {
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-full lg:max-w-4xl mx-auto w-full px-4 sm:px-6 md:px-8">
        <WobbleCard
          containerClassName="col-span-1 md:col-span-2 lg:col-span-2 h-full bg-pink-800 min-h-[300px] lg:min-h-[300px]"
          className=""
        >
          <div className="max-w-xs">
            ...
            <p className="mt-4 text-left text-base md:text-lg lg:text-xl text-neutral-200">
        ...
        <WobbleCard containerClassName="col-span-1 lg:col-span-1 bg-blue-900 min-h-[300px] lg:min-h-[300px]">
          <div className="max-w-xs">
            <h2 className="text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
